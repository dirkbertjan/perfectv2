# This scripts trains the ablation of position of the mask in table 7.
...
# 3) we set the "mask_position" to ["0", "1", "2", "3"]
...
python run_clm.py configs/perfect_mask_position_ablation.json 
