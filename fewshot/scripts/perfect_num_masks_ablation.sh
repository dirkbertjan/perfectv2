# This scripts trains the ablation of number of masks in table 5.
...
# 3) we set "num_extra_tokens": [1, 2, 5, 10], which specifies the number of masks.
...
python run_clm.py configs/perfect_num_masks_ablation.json 